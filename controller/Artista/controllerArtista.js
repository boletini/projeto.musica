...
const inserirArtista = async function(musica, contentType){
    ...
    try {
        ...
        if(String(contentType).toLowerCase() == 'application/json')
        {
            ...
            if (
                ...
                artista.data_nascimento   ==       undefined    ||    artista.data_nascimento   == '' || artista.data_nascimento    == null      || artista.data_nascimento.length      > 200 ||
                artista.biografia         ==       undefined    ||    artista.biografia         == '' || artista.biografia          == null      || artista.biografia.length            > 10  ||
            )
            {
