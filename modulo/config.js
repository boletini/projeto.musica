...
const ERROR_CONTENT = {status: false,status_code: 415, menssage:'Não foi possivel pois o tipo de dado encaminhado não foi aceito na API. Você deve encaminhar apenas JSON'}
